import {Header,Accordion,label,Segment,Icon,Button,List, Label, ListItem,Image} from 'semantic-ui-react'
              ...
              {order.products.map(p => (
                <List.Item key={p.product._id}>
                 ...
                 <List.Content>
                  ...
                  <List.Description>{p.quantity} . Php{p.product.price}</List.Description>
                 </List.Content>
